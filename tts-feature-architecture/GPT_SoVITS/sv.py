...
eres2net_dir = os.path.join(current_file_dir, "eres2net")
if eres2net_dir not in sys.path:
    sys.path.insert(0, eres2net_dir)

# Resolve sv_path relative to this file's directory
sv_path = os.path.join(current_file_dir, "pretrained_models", "sv", "pretrained_eres2netv2w24s4ep4.ckpt")
